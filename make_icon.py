"""
Generate the app icon — a dark disc with a cyan play triangle and film
perforations on the sides. Multi-size .ico for Windows (16/24/32/48/64/
128/256). Run once; commit the output as assets/icon.ico.
...
PNG_OUT = Path(__file__).resolve().parent / "assets" / "icon.png"
